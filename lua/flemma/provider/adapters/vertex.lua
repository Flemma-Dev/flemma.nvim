...
---Query Vertex AI's `:countTokens` endpoint and report the result via on_result.
---Caller owns formatting + notifying. Reuses the full `build_request` pipeline,
---minus `generationConfig` (count endpoint doesn't generate).
---@param bufnr integer
