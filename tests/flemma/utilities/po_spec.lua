...
describe("flemma.utilities.po", function()
  ...
  describe("shipped catalogues", function()
    ...
    describe_catalogue("po/flemma-harness.po", {
      ...
      "tool.truncate.output_too_large",
      "tool.truncate.output_too_large_with_overflow",
      "tool.truncate.showing_last",
      "tool.truncate.showing_last_with_overflow",
      "tool.truncate.showing_lines",
      "tool.truncate.showing_lines_with_overflow",
      "tool.truncate.showing_lines_byte_limit",
      "tool.truncate.showing_lines_byte_limit_with_overflow",
      ...
      "tool.grep.personality.snippet",
      "tool.grep.personality.guidelines",
      "tool.grep.footer",
      "tool.grep.footer_limit_reached",
      "tool.ls.description",
      "tool.ls.input.label",
      "tool.ls.input.path",
      "tool.ls.input.max_depth",
      "tool.ls.input.limit",
      "tool.ls.personality.snippet",
      "tool.ls.personality.guidelines",
      "tool.ls.footer",
      "tool.ls.footer_with_depth",
      "tool.read.description",
      "tool.read.input.label",
      "tool.read.input.path",
      "tool.read.input.offset",
      "tool.read.input.limit",
      "tool.read.personality.snippet",
      "tool.read.personality.guidelines",
      "tool.write.description",
      "tool.write.input.label",
      "tool.write.input.path",
      "tool.write.input.content",
      "tool.write.personality.snippet",
      "tool.write.personality.guidelines",
      "tool.error.no_path",
      "tool.error.no_pattern",
      "tool.error.sandbox",
      "tool.error.timer",
      "tool.error.job_start",
      "tool.error.file_not_found",
      "tool.error.write_failed",
      "tool.error.exit_code",
      "tool.bash.error.no_command",
      "tool.bash.no_output",
      "tool.bash.timeout",
      "tool.edit.error.no_old_text",
      "tool.edit.error.no_new_text",
      "tool.edit.error.sandbox_denied",
      "tool.edit.error.read_failed",
      "tool.edit.error.text_not_found",
      "tool.edit.error.not_unique",
      "tool.edit.error.no_changes",
      "tool.edit.output.success",
      "tool.find.error.no_backend",
      "tool.find.no_matches",
      "tool.find.footer_limited",
      "tool.find.footer_truncated",
      "tool.find.timeout",
      "tool.flemma.jobs.status.state_running",
      "tool.flemma.jobs.status.state_delivery_pending",
      "tool.flemma.jobs.status.state_completed",
      "tool.flemma.jobs.status.state_removed",
      "tool.grep.error.no_backend",
      "tool.grep.error.exit_code",
      "tool.grep.no_matches",
      "tool.grep.error.job_start",
      "tool.grep.timeout",
      "tool.ls.error.not_found",
      "tool.read.offset_beyond_eof",
      "tool.read.line_exceeds_limit",
      "tool.read.truncated_lines",
      "tool.read.truncated_bytes",
      "tool.read.more_lines",
      "tool.write.error.no_content",
      "tool.write.error.sandbox_denied",
      "tool.write.success",
      "tool.mcporter.empty_output",
      "tool.mcporter.call_failed",
      "tool.mcporter.parse_failed",
      "tool.mcporter.stderr",
      "tool.mcporter.start_failed",
      "tool.mcporter.timeout",
    })
    ...
    describe_catalogue("po/flemma.po", {
      ...
      "ui.parse.tool_result_no_fence",
      "ui.parse.tool_input_failed",
      "ui.parse.tool_use_unclosed_fence",
      "ui.parse.tool_use_no_fence",
      "ui.progress.waiting",
