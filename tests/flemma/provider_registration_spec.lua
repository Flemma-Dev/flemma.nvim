...
describe("provider registration", function()
  ...
  describe("get_default_parameters()", function()
    ...
    it("returns nil for provider without default parameters", function()
      assert.is_nil(registry.get_default_parameters("openai"))
    end)
...
describe("merge_parameters with registered defaults", function()
  ...
  it("returns empty table for provider with no registered defaults", function()
    local merged = config_manager.merge_parameters({}, "openai")
    -- Should just be empty (no defaults registered for openai)
    assert.is_nil(merged.cache_retention)
  end)
end)
