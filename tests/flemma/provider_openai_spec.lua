...
describe("OpenAI Provider", function()
      ...
      local prompt = {
        ...
        history = {
          { role = "user", parts = { { kind = "text", text = "Hello" } } },
          {
            role = "assistant",
            parts = {
              { kind = "thinking", content = "some old thinking" },
  ...
  describe("metadata", function()
    ...
    it("should include reasoning_summary default in config_schema", function()
      local defaults = openai.metadata.config_schema:materialize()
      assert.equals("auto", defaults.reasoning_summary)
    end)
  end)
end)
