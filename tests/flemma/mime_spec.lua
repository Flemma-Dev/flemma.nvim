...
describe("MIME type detection", function()
  ...
  describe("is_binary", function()
    ...
    it("returns false for image/svg+xml (XML text)", function()
      assert.is_false(mime.is_binary("image/svg+xml"))
    end)

    it("returns true for binary image types", function()
  ...
  describe("is_image", function()
    it("returns true for binary image types", function()
      assert.is_true(mime.is_image("image/png"))
      assert.is_true(mime.is_image("image/jpeg"))
      assert.is_true(mime.is_image("image/gif"))
      assert.is_true(mime.is_image("image/webp"))
    end)

    it("returns true for SVG", function()
      assert.is_true(mime.is_image("image/svg+xml"))
    end)

    it("returns false for non-image types", function()
      assert.is_false(mime.is_image("text/plain"))
      assert.is_false(mime.is_image("application/pdf"))
      assert.is_false(mime.is_image("application/json"))
    end)
  end)

  describe("is_pdf", function()
    it("returns true for application/pdf", function()
      assert.is_true(mime.is_pdf("application/pdf"))
    end)

    it("returns false for other types", function()
      assert.is_false(mime.is_pdf("image/png"))
      assert.is_false(mime.is_pdf("text/plain"))
      assert.is_false(mime.is_pdf("application/json"))
    end)
  end)
