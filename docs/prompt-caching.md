...
Flemma supports prompt caching across all three providers. Each provider implements caching differently, but the user-facing `cache_retention` parameter provides a consistent interface.
